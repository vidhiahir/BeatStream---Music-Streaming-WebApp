        ...
        <div className="flex flex-col items-center gap-2 flex-1 max-w-full sm:max-w-[45%]">
          <div className="flex items-center gap-4 sm:gap-6">
            {/* <Button
              size="icon"
              variant="ghost"
              className="hidden sm:inline-flex hover:bg-[var(--bg-hover)] text-[var(--text-color)]"
            >
            ...
            <Button
              size="icon"
              variant="ghost"
              className="hover:bg-[var(--bg-hover)] text-[var(--text-color)]"
            ...
            <Button
              size="icon"
              className="bg-[var(--bg-2)] hover:[var(--bg-2)] text-[var(--text-color)] rounded-full h-8 w-8"
              onClick={togglePlay}
              disabled={!currentSong}
            >
              {isPlaying ? (
